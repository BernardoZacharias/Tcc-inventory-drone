...
exports.obter = async (req, res) => {
  try {
    const empresa = await service.obter(req.params.id);
...
exports.criar = async (req, res) => {
  try { ok(res, await service.criar(req.body), 201); } catch (e) { fail(res, e); }
};

exports.atualizar = async (req, res) => {
  try { ok(res, await service.atualizar(req.params.id, req.body)); } catch (e) { fail(res, e); }
};
